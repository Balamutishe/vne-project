        ...
        list: [
          {
            ...
            previewImageUrl:
              "/images/product/men/trousers/balloonTrousers-5.jpg",
            gender: "men",
            category: "trousers",
            topList: false,
            details: {
          ...
          },
          {
            ...
            previewImageUrl:
              "/images/product/men/trousers/sportsTrousers-5.jpg",
            gender: "men",
            category: "trousers",
            topList: false,
            details: {
        ...
        list: [
          {
            ...
            previewImageUrl:
              "/images/product/men/t-shirts/oversizedTShirt-5.jpg",
            gender: "men",
            category: "t-shirts",
            topList: false,
            details: {
        ...
        list: [
          {
            ...
            previewImageUrl:
              "/images/product/men/sweaters/oversizedHoodie-4.jpg",
            gender: "men",
            category: "sweaters",
            topList: false,
            details: {
        ...
        list: [
          {
            ...
            previewImageUrl: "/images/product/accessories/men-cap-1.jpg",
            gender: "men",
            category: "caps",
            topList: false,
            details: {
      ...
      },
      {
        ...
        list: [
          ...
          },
          {
            ...
            previewImageUrl:
              "/images/product/women/trousers/looseTrousers-5.jpg",
            gender: "women",
            category: "trousers",
            topList: false,
            details: {
        ...
        list: [
          {
            ...
            previewImageUrl: "/images/product/accessories/women-bagVest-1.jpg",
            gender: "women",
            category: "bags",
            topList: false,
            details: {
...
export const getTopList = () => {
  ...
  const result: TProduct[] = Object.values(dataAll).flatMap((collection) => {
    return Object.values(collection)
      .flat()
      .map(({ list }) => {
        return list.filter((product: TProduct) => product.topList === true);
      })
      .flat();
  });

  return {
    title: "СТИЛЬ ВНЕ ВРЕМЕНИ",
    data: result,
  };
};

export const getDataByCategory = (collection: TGender, category: string) => {
  if (!category || !collection) throw new Error("category or gender not found");

  const currentCollection = getDataByCollection(collection);

  if (!currentCollection) throw new Error("collection not found");

  return Object.values(currentCollection)
    .flat()
...
export const getDataByFilter = (
  ...
  if (collection && !category) {
    ...
    if (!currentCollection) throw new Error("category not found");

    const result: TProduct[] = Object.values(currentCollection)
      .flat()
      .map(({ list }) => {
        return list.filter((product: TProduct) => {
  ...
  if (collection && category) {
    const currentCategory = getDataByCategory(collection, category);

    if (!currentCategory) throw new Error("category not found");

    const result = currentCategory.list.filter((product) => {
      return product.name.toLowerCase().includes(filter.toLowerCase());
    });
...
export const getDataProductById = (
  ...
  const currentCollection: TCollection = getDataByCollection(collection);

  const product = Object.values(currentCollection)
    .flat()
    .find(({ slug }) => slug === category)!
